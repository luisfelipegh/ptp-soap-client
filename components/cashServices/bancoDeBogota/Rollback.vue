...
export default {
    ...
    beforeMount() {
        ...
        if (localStorage.getItem(`bancoDeBogota.paymentConfirmationCode`)) {
            this.paymentConfirmationCode = JSON.parse(localStorage.getItem(`bancoDeBogota.paymentConfirmationCode`))
        }
